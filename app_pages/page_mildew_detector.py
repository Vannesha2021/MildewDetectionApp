...
def page_mildew_detector_body():
    st.info(
        f"* The client is interested to tell whether a given leaf is infected by Mildew "
        f"or not."
        )

    st.write(
        f"* You can download a set of healthy and mildew leaves for live prediction. "
